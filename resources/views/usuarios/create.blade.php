    ...
    <div class="w-full max-w-md sm:max-w-lg lg:max-w-xl mx-auto mt-28 mb-14">
        <div class="bg-white rounded-lg shadow-xl overflow-hidden">
            <div class="px-6 py-8 sm:px-8 text-center">
                ...
                <h2 class="text-2xl sm:text-3xl font-bold text-gym-primary mb-2">Crear Nuevo Usuario</h2>
                <p class="text-gray-600 text-sm sm:text-base">Únete a OneUp GYM y comienza tu transformación</p>
            </div>
            ...
            <div class="px-6 pb-8 sm:px-8">
                <form method="POST" action="{{ route('usuarios.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="lastName" class="block text-sm font-medium text-gray-700 mb-2">Apellido <span class="text-red-500">*</span></label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label for="password"
                                class="block text-sm font-medium text-gray-700 mb-2">Contraseña <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label for="rol" class="block text-sm font-medium text-gray-700 mb-2">Rol <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        ...
                        <input name="celular" type="tel" value="{{ old('celular') }}"
                            class="w-full px-3 py-3 sm:py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gym-secondary focus:border-gym-secondary text-sm sm:text-base"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input name="peso" type="number" min="0" value="{{ old('peso') }}"
                                class="w-full px-3 py-3 sm:py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-gym-secondary focus:border-gym-secondary text-sm sm:text-base"
                                placeholder="kg" />
                            @error('peso')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        ...
                        <div>
                            <label for="altura" class="block text-sm font-medium text-gray-700 mb-2">Altura <span
                                    class="text-gray-400 text-xs">(opcional)</span></label>
                            <input name="altura" type="number" min="100" value="{{ old('altura') }}"
                                class="w-full px-3 py-3 sm:py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-gym-secondary focus:border-gym-secondary text-sm sm:text-base"
                                placeholder="cm" />
                            @error('altura')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
