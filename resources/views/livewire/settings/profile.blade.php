...
<div class="container mx-auto px-4 py-8">   
    ...
    @if (session('contraseña-actualizada'))
        <x-alerts.success>{{ session('contraseña-actualizada') }}</x-alerts.success>
    @endif
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow-lg p-6 sticky top-4 h-full">
                ...
                <a wire:navigate href="{{route('settings.password')}}" 
                    class="w-full inline-block text-center bg-gym-secondary text-white py-2 px-4 rounded-md font-medium hover:bg-gym-primary transition-colors mt-2">
                    Editar Contraseña
                </a>
